...
let info = {
    ...
    favFoods: ["Burger", "Adobo", "Fries"],
    hobbies: ["Playing Online Games", "Watching Netflix", "Playing Ukulele", "Craving"],
    placesLived: [{place: "Quezon City",timeLived: 24},]
}
...
foodList = info.favFoods;

for (let i = 0; i < foodList.length; i++) {
    let list = document.createElement('li');
    list.innerText = foodList[i];
    document.querySelector('#fav-foods').appendChild(list);
}
